; original version from project https:/github.com/codebrickie/rsscljvaadin

(ns clj.reindeer.example.rssapplicationui
  ...
  (:gen-class
    :name clj.reindeer.example.RSSApplicationUI
...
(defn- create-url-field
  []
  (doto (TextField.)
    (.setInputPrompt "Feed URL") ; example: http://jaxenter.de/all-rss.xml
    (.setWidth "50%")))
